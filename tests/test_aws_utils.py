...
class TestAWSUtils:
    ...
    def test_send_sqs_message_success(self, mock_sqs_client):
        ...
        body = "test message"
        attributes = {
            "TestAttribute": {"DataType": "String", "StringValue": "test_value"}
        }
    ...
    def test_send_sqs_message_with_custom_region(self):
        ...
        with patch("boto3.client") as mock_boto_client:
            ...
            result = AWSUtils.send_sqs_message(
                queue_url, body, attributes, region="us-west-2"
            )
    ...
    def test_send_sqs_message_parameters(self):
        ...
        attributes = {"TestAttr": {"DataType": "String", "StringValue": "test_value"}}
    ...
    def test_send_batch_sqs_messages_with_custom_region(self):
        ...
        with patch("boto3.client") as mock_boto_client:
            ...
            result = AWSUtils.send_batch_sqs_messages(
                queue_url, bodies, attributes, region="eu-west-1"
            )
